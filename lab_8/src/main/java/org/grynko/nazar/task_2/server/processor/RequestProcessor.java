package org.grynko.nazar.task_2.server.processor;

import org.grynko.nazar.task_2.common.constant.*;
import org.grynko.nazar.task_2.common.model.Group;
import org.grynko.nazar.task_2.common.model.Student;
...
import org.grynko.nazar.task_2.server.dao.GroupDao;
import org.grynko.nazar.task_2.server.dao.StudentDao;
...
public class RequestProcessor {
    ...
    public ParameterizedResponse getResponse(ParameterizedRequest request) {
        lock.lock();
        ParameterizedResponse response = process(request);
        lock.unlock();
